  ...
  return (
    <div>
      <div className="w-full flex items-center justify-center mt-5">
        <span className="text-center dark:text-white text-black text-[15px] font-medium">
          Transfer USD 5,000 to the details below
        </span>
      </div>
      <div className="w-full border border-[#E2E3E7] bg-[#F3F3F3] dark:bg-[#141415] dark:border-[#242425] px-3 py-3 flex flex-col gap-2 text-sm rounded-md mt-5">
        <div className="w-full flex justify-between items-center">
          <span className="text-[#696F79] dark:text-[#888888]">
            Account holder
          </span>
          <span className="dark:text-white text-black">LINK FINANCIAL INC</span>
        </div>
        <div className="w-full flex justify-between items-center">
