  ...
  return (
    <div>
      <div className="w-full min-h-[250px]  flex flex-col items-center justify-center gap-4">
        ...
        <span className="font-medium  max-w-[300px]  text-xs dark:text-[#888888] text-center text-black">
          You’ll be connecting via Plaid to make a bank transfer payment
        </span>
      </div>
      <div className="w-full flex flex-col items-center  ">
        <button className="w-full text-white bg-[#0E70FD] rounded-lg text-sm text-center py-2 ">
          Pay via Plaid
        </button>
      </div>
    </div>
