...
export const PaymentSuccessfulState = () => {
  ...
  return (
    <div>
      <div className="w-full mt-16 flex items-center flex-col min-h-[200px] ">
        <SuccessAnimation></SuccessAnimation>
        {isDone ? (
          <span className="text-[#696F79] dark:text-[#888888] mt-4  text-sm font-medium  text-center max-w-[450px]">
      ...
      <div className="w-full">
        <button
          disabled={isDone}
          className={`w-full text-white bg-[#0E70FD]  rounded-lg text-center  py-2 ${isDone ? "opacity-0" : ""}`}
