    ...
    <>
      <div>
        <div className="w-full flex items-center justify-center mt-8">
          <span className="text-center dark:text-[#F9F9F9] text-black text-[17px] font-medium">
            Select how you would like to pay
          </span>
        </div>

        <div className="w-full min-h-[250px]  mt-5  flex flex-col gap-3">
          <label
            className={`flex flex-row h-[70px] px-5 justify-between border-[0.8px] items-center  border-[#E2E3E7] bg-[#F3F3F3] dark:border-[#242425] dark:bg-[#141415] w-full rounded-lg dark:text-[#F9F9F9] dark:hover:border-[#9F9F9F] hover:border-black ${
          ...
          <label
            className={`flex flex-row h-[70px] px-5 justify-between border-[0.8px] items-center  border-[#E2E3E7] bg-[#F3F3F3] dark:hover:border-[#9F9F9F] dark:border-[#242425] dark:bg-[#141415] w-full rounded-lg dark:text-[#F9F9F9] hover:border-black ${
          ...
          >
            <div className="flex items-center gap-2 ">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-[#696F79]">
